...
| L1 | C18-ADM-001 | CAP-L0-THREAT-MODELER | Administration Governance Control Plane | Enforce branch-planning linkage, PR issue synchronization, checklist gating and retention, release-readiness review, and governance cadence controls as executable policy checks. | ADM-001, ADM-002, ADM-003, ADM-004, ADM-005, ADM-006 | Requirements/06_Project_Administration_Requirements.md; Requirements/04_Traceability_Matrix.md | docs/architecture/Capability_Function_Architecture_Traceability_Matrix.md; docs/design/system/Functional_Data_Flow_Design_Traceability_Package.md; docs/design/software/Runtime_And_Orchestration_Design_Specification.md | scripts/verify_administration_controls.py | Tests/unit/test_administration_controls.py; Requirements/15_End_To_End_Traceability_Attributes_Registry.md |
