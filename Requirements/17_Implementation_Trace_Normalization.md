...
- GUI-026 -> implementation: frontend/src/components/ExecutionProgress.tsx; scripts/live_browser_e2e_smoke.py (IER action continued mitigation; ground truth from 04_ + 10_GUI annex + ExecutionProgress + e2e) [added 2026-06-07]
- GUI-029 -> implementation: src/threat_modeler/ui/screens/last_prompt.py (IER action continued; prompt correlation + stale suppression from 01/10 annex + last_prompt impl + unit test) [added 2026-06-07]
- PRJ-011 -> implementation: frontend/src/App.tsx; frontend/src/api/client.ts (IER action continued; exportable outputs JSON/STIX/Mermaid/MD from 01_Project annex + App + client) [added 2026-06-07]
