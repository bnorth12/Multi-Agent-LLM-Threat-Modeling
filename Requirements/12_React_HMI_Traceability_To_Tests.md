...
| RHMI-005 LLM watchdog telemetry | Requirements/11_React_HMI_Refactor_Requirements.md | GET /runs with heartbeat fields | scripts/live_browser_e2e_smoke_react.py | FQT/fqt_react_*/test_report.json |
