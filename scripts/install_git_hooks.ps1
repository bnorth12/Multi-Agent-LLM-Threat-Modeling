...
Write-Host "Governance execution (including independent review) is written under independent_reviews/latest."
Write-Host ""
Write-Host "KNOWN EXCEPTION: After pre-push/push the canonical independent_reviews/latest/"
Write-Host "independent_review_<sprint>_pre-push.{md,json} will be modified (single review file policy)."
Write-Host "These two tracked files are the documented exception to clean-tree expectations."
Write-Host "They are the live independent review output; commit them with your change."
Write-Host ""
