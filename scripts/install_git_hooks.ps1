...
Write-Host " - INDEPENDENT_REVIEW_SPRINT accepts YYYY-NN, YYYY_NN, YYYY-NNN, or YYYY_NNN (default 2026_12)"
...
Write-Host " - .\scripts\run_governance_planning.ps1 -Sprint 2026_12"
Write-Host " - .\scripts\run_governance_closeout.ps1 -Sprint 2026_12"
