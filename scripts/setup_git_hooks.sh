...
echo "Governance execution (including independent review) written under independent_reviews/latest."
echo ""
echo "KNOWN EXCEPTION: After pre-push the canonical independent_reviews/latest/"
echo "independent_review_<sprint>_pre-push.{md,json} will be modified (single review file policy)."
echo "These two tracked files are the documented exception to clean-tree expectations."
echo "Commit them with your change (they are the live independent review evidence)."
echo ""
echo "Env toggles:"
