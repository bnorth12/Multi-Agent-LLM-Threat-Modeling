...
**Report ID:** FQT-UAS-20260515_232859
**Test Date:** 2026-05-15 23:41:47
...
| **Test Status** | **FAIL ❌** |
| **Total Duration (seconds)** | 767 |
| **Stages Completed** | 9/9 |
| **HITL Gates Approved** | 5 |
| **Threat Count Detected** | 23 |
| **Token Usage (Total)** | 167,024 |
...
| ≥1 threat detected | ≥1 | 23 | ✅ PASS |
| ≥5 export controls respond | ≥5 | 4 | ❌ FAIL |
...
| 10 | Export controls produce downloadable artifacts | 4 artifact(s) downloaded to downloads/ | ✅ CONFIRMED |
...
```
FQT/
├── 20260515_232859/           # Test execution directory
...
**Report Generated:** 2026-05-15 23:41:47
**Status:** ✅ Downloaded
