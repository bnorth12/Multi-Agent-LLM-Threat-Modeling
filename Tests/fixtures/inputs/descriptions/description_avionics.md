...
2. **Digital-Actuation Boundary** — separates digital command generation (C-FCC-01) from electro-hydraulic actuation hardware (C-SERVO-01). Crossed by DF-204.
3. **Actuation-Sensing Boundary** — separates analog sensor feedback (C-SERVO-01) from digital control processing (C-FCC-01). Crossed by DF-205.
