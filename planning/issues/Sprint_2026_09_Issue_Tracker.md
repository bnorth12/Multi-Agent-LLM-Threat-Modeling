...
|-----------|----------|------|--------------|--------|------------|--------------|---------------------|
| D-S09-001 | Medium | STIX Viewer | Need dedicated STIX object viewer in GUI; current path is raw/export-only | In Progress | Pending | Tests/integration/test_stix_viewer_screen.py (8 passed) | 2026-05-10 BN: Implemented STIX viewer screen with grouping, counts, and filter/search; awaiting full automated suite pass |
| D-S09-002 | Medium | Canonical Graph Viewer | Need navigable canonical graph viewer; current path is raw/export-only | In Progress | Pending | Pending | 2026-05-10 BN: Viewer implemented; awaiting automated suite execution |
| D-S09-003 | Medium | Mermaid Diagram Viewer | Need in-app Mermaid render/source viewer for generated diagrams | In Progress | Pending | Pending | 2026-05-10 BN: Viewer implemented with source toggle and explicit invalid-source error handling |
| D-S09-004 | Medium | STRIDE Viewer and Export | Need dedicated STRIDE viewer plus standalone export artifact | In Progress | Pending | Pending | 2026-05-10 BN: STRIDE viewer and standalone JSON/CSV export added; awaiting automated verification |
| D-S09-005 | Low | Results Export Quick Preview | Quick preview options do not function reliably for active run artifacts | In Progress | Pending | Pending | 2026-05-10 BN: Quick preview coverage expanded; validating current-run correctness via tests |
| D-S09-006 | Medium | Component/File Version Governance | Need component semantic version manifest and component-file version inventory for RC evidence and traceable release auditing | In Progress | Pending | Pending | 2026-05-10 BN: Generators implemented and surfaced in Results Export + Snapshot Manager |
...
| D-S09-008 | Medium | Manual RC Validation Campaign and Documentation Proof | Need full manual release-candidate validation evidence including user manual, product documentation, and deployment guide verification after clean automated pass for all RC-included features | Open | Pending | Pending | 2026-05-10 BN: Updated gating policy to require clean automated pass before manual RC campaign |
| D-S09-009 | Medium | Markdown Viewer and Editor | Need integrated markdown viewer/editor for tool-managed files to support in-app updates during requirements and implementation phases | In Progress | Pending | Pending | 2026-05-09 BN: Implementation started; markdown display, edit, preview, and snapshot persistence implemented; 14 integration tests passing |
