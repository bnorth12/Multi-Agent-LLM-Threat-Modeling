...
| T-PLN-03 | not_started | `planning/` older closeout checklists and branch-era sprint collateral | Scrum Master | active sprint references and closeout docs must be checked before moving any checklist or branch collateral | dated tranche note; archive index update; retargeted references | `python scripts/archive_hygiene.py check --paths planning/Sprint_2026_08_Closure_Checklist.md --enforce` |
| T-DOC-01 | not_started | `docs/screenshots/` historical evidence references | Documentation Owner | `docs/screenshots/README.md` must keep valid links to archived planning evidence until screenshots are re-indexed elsewhere | updated screenshot evidence index and valid archive links | `npx --yes markdownlint-cli docs/screenshots/README.md planning/archives/README.md planning/archives/2026-05/README.md` |
